...
namespace WebAPI_EF.Models
{
    ...
    public partial class InfiniteDBEntities : DbContext
    {
        ...
        public virtual ObjectResult<spGetProductsByName_Result> spGetProductsByName(string prodname)
        {
            var prodnameParameter = prodname != null ?
                new ObjectParameter("prodname", prodname) :
                new ObjectParameter("prodname", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetProductsByName_Result>("spGetProductsByName", prodnameParameter);
        }
